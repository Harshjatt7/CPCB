...
class StringConstants {
  ...
  final String enterEmailPasswordToLogin = "enter-email-pass-to-sign-in";
  final String loginToYourAcc = "login-to-your-acc";
  final String forgotPassLabel = "forgot-password-label";
  final String loginBtnLabel = "login-btn-label";
  final String emailIdHint = "email-id-hint";
  final String selectUserHint = "select-user-hint";
  final String passwordHint = "Password";
  final String downloadApplicationBtnLabel = "download-application-btn-label";
  final String downloadPaymentReciptBtnLabel =
      "download-payment-recipt-btn-label";
  final String eprComplianceTitle = "epr-compliance-title";
  final String environmentCompensationTitle = "environment-compensation-title";
  final String descripsionTitle = "descripsion-title";
  ...
  final String scooterLabel = "scooter-label";
  final String truckLabel = "truck-label";
  final String busLabel = "bus-label";
  final String lcvLabel = "lcv-label";
