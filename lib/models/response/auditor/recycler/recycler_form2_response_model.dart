...
AuditorRecyclerForm2ResponseModel auditorRecyclerForm2ResponseModelFromJson(
        String str) =>
    AuditorRecyclerForm2ResponseModel.fromJson(json.decode(str));

String auditorRecyclerForm2ResponseModelToJson(
        AuditorRecyclerForm2ResponseModel data) =>
...
class AuditorRecyclerForm2ResponseModel {
  ...
  factory AuditorRecyclerForm2ResponseModel.fromJson(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        processingCapacity: (json["processingCapacity"] == null ||
                (json["processingCapacity"] != null &&
                    json["processingCapacity"].length == 0))
            ? null
            : ProcessingCapacity.fromJson(json["processingCapacity"]),
      );
...
class ProcessingCapacity {
  ...
  factory ProcessingCapacity.fromJson(Map<String, dynamic> json) =>
      ProcessingCapacity(
        planCapacityAssesment: json["planCapacityAssesment"] == null
            ? null
            : PlanCapacityAssesment.fromJson(json["planCapacityAssesment"]),
        valueComparable: json["valueComparable"] == null
            ? null
            : ValueComparable.fromJson(json["valueComparable"]),
        electricityVerification: json["electricityVerification"] == null
            ? null
            : ElectricityVerification.fromJson(json["electricityVerification"]),
        cAndDComparable: json["cAndDComparable"] == null
            ? null
            : CAndDComparable.fromJson(json["cAndDComparable"]),
      );
...
class CAndDComparable {
  ...
  factory CAndDComparable.fromJson(Map<String, dynamic> json) =>
      CAndDComparable(
...
class ElectricityVerification {
  ...
  factory ElectricityVerification.fromJson(Map<String, dynamic> json) =>
      ElectricityVerification(
        auditValue: json["audit_value"],
        auditDocument: json["audit_document"],
        auditRemark: json["audit_remark"],
        ...
        additionalData: json["additional_data"] == null
            ? null
            : ElectricityVerificationAdditionalData.fromJson(
...
class ElectricityVerificationAdditionalData {
  ...
  factory ElectricityVerificationAdditionalData.fromJson(
          Map<String, dynamic> json) =>
      ElectricityVerificationAdditionalData(
...
class PlanCapacityAssesment {
  ...
  factory PlanCapacityAssesment.fromJson(Map<String, dynamic> json) =>
      PlanCapacityAssesment(
        auditValue: json["audit_value"],
        auditDocument: json["audit_document"],
        auditRemark: json["audit_remark"],
        ...
        additionalData: json["additional_data"] == null
            ? null
            : PlanCapacityAssesmentAdditionalData.fromJson(
                json["additional_data"]),
      );
...
class PlanCapacityAssesmentAdditionalData {
  ...
  factory PlanCapacityAssesmentAdditionalData.fromJson(
          Map<String, dynamic> json) =>
      PlanCapacityAssesmentAdditionalData(
        typeOfEndProduct: json["type_of_end_product"] == null
            ? []
            : List<String>.from(json["type_of_end_product"]!.map((x) => x)),
        ...
        actualProcessingCapacityDerived:
            json["actual_processing_capacity_derived"],
      );
...
class ValueComparable {
  ...
  factory ValueComparable.fromJson(Map<String, dynamic> json) =>
      ValueComparable(
        auditValue: json["audit_value"],
        auditDocument: json["audit_document"],
        auditRemark: json["audit_remark"],
        ...
        additionalData: json["additional_data"] == null
            ? null
            : ValueComparableAdditionalData.fromJson(json["additional_data"]),
      );
...
class ValueComparableAdditionalData {
  ...
  factory ValueComparableAdditionalData.fromJson(Map<String, dynamic> json) =>
      ValueComparableAdditionalData(
