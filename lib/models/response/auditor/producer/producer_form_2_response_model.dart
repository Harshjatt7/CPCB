...
String producerForm2ResponseModelToJson(ProducerForm2ResponseModel data) =>
...
class ProducerForm2ResponseModel {
  ...
  factory ProducerForm2ResponseModel.fromJson(Map<String, dynamic> json) =>
      ProducerForm2ResponseModel(
        data: json["data"] == null
            ? null
            : ProducerForm2ResponseData.fromJson(json["data"]),
      );
...
class ProducerForm2ResponseData {
  ...
  factory ProducerForm2ResponseData.fromJson(Map<String, dynamic> json) =>
      ProducerForm2ResponseData(
          auditPlanId: json["auditPlanId"],
          salesData: json["salesData"] == null
              ? null
              : ProducerForm2SalesData.fromJson(json["salesData"]),
          auditSummary: (json["auditSummary"] == null ||
                  (json["auditSummary"] != null &&
                      json["auditSummary"].length == 0))
              ? null
              : AuditSummaryForm2Response.fromJson(json["auditSummary"]));
...
class AuditSummaryForm2Response {
  ...
  factory AuditSummaryForm2Response.fromJson(Map<String, dynamic> json) =>
      AuditSummaryForm2Response(
        salesP2:
        ...
        salesP3:
            json["salesP3"] == null ? null : SalesP.fromJson(json["salesP3"]),
        salesP4:
            json["salesP4"] == null ? null : SalesP.fromJson(json["salesP4"]),
        salesP5:
            json["salesP5"] == null ? null : SalesP.fromJson(json["salesP5"]),
        salesP6:
            json["salesP6"] == null ? null : SalesP.fromJson(json["salesP6"]),
      );
...
class ProducerForm2SalesData {
  ...
  factory ProducerForm2SalesData.fromJson(Map<String, dynamic> json) =>
      ProducerForm2SalesData(
        p1: json["p1"] == null
            ? []
            : List<Producer>.from(json["p1"]!.map((x) => Producer.fromJson(x))),
        p2: json["p2"] == null
            ? []
            : List<Producer>.from(json["p2"]!.map((x) => Producer.fromJson(x))),
        p3: json["p3"] == null
            ? []
            : List<Producer>.from(json["p3"]!.map((x) => Producer.fromJson(x))),
        p4: json["p4"] == null
            ? []
            : List<Producer>.from(json["p4"]!.map((x) => Producer.fromJson(x))),
        p5: json["p5"] == null
            ? []
            : List<Producer>.from(json["p5"]!.map((x) => Producer.fromJson(x))),
        p6: json["p6"] == null
            ? []
            : List<Producer>.from(json["p6"]!.map((x) => Producer.fromJson(x))),
      );
