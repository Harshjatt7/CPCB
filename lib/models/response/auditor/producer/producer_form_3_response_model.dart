...
ProducerForm3ResponseModel producerForm3ResponseModelFromJson(String str) =>
    ProducerForm3ResponseModel.fromJson(json.decode(str));

String producerForm3ResponseModelToJson(ProducerForm3ResponseModel data) =>
...
class ProducerForm3ResponseModel {
  ...
  factory ProducerForm3ResponseModel.fromJson(Map<String, dynamic> json) =>
      ProducerForm3ResponseModel(
        data: json["data"] == null
            ? null
            : ProducerForm3Data.fromJson(json["data"]),
      );
...
class ProducerForm3Data {
  ...
  factory ProducerForm3Data.fromJson(Map<String, dynamic> json) =>
      ProducerForm3Data(
        ...
        auditSummary: (json["auditSummary"] == null ||
            ...
            ? null
            : ProducerForm3AuditSummary.fromJson(json["auditSummary"]),
      );
...
class ProducerForm3AuditSummary {
  ...
  factory ProducerForm3AuditSummary.fromJson(Map<String, dynamic> json) =>
      ProducerForm3AuditSummary(
        missReporting: json["missReporting"] == null
            ? null
            : MissReporting.fromJson(json["missReporting"]),
        falseInformation: json["falseInformation"] == null
            ? null
            : FalseInformation.fromJson(json["falseInformation"]),
      );
...
class FalseInformation {
  ...
  factory FalseInformation.fromJson(Map<String, dynamic> json) =>
      FalseInformation(
        ...
        additionalData: json["additional_data"] == null
            ? null
            : FalseInformationAdditionalData.fromJson(json["additional_data"]),
      );
...
class FalseInformationAdditionalData {
  ...
  factory FalseInformationAdditionalData.fromJson(Map<String, dynamic> json) =>
      FalseInformationAdditionalData(
...
class MissReporting {
  ...
  factory MissReporting.fromJson(Map<String, dynamic> json) => MissReporting(
        ...
        additionalData: json["additional_data"] == null
            ? null
            : MissReportingAdditionalData.fromJson(json["additional_data"]),
      );
...
class MissReportingAdditionalData {
  ...
  factory MissReportingAdditionalData.fromJson(Map<String, dynamic> json) =>
      MissReportingAdditionalData(
