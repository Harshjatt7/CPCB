...
class SpcbProducerTab extends StatelessWidget {
  SpcbProducerTab({super.key, required this.data,required this.onScrollEnding, required this.scrollController,  this.onPopUpSubmit, required this.viewModel});
                ...
                child: data.isEmpty
                    ...
                    : Column(
                        ...
                        children: List<Widget>.generate(
                            data.length , (index) {
                          final applicationData = data.isEmpty ? null : data[index];
                          return Padding(
                            padding: const EdgeInsets.symmetric(vertical: 8),
