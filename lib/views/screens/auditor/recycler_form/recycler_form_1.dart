            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: RecyclerDataTable(
                    isSummary: widget.isSummaryScreen,
                    machineControllerList:
                        viewModel.plantMachineryControllerList,
                    radioList: viewModel.plantMachineyRadioList,
                    nwList: viewModel.nw ?? [],
                    headingList: viewModel.recyclerHeadingList,
                  ),
                  ...
                  child: PlantMachineryWidget(
                    ...
                    onTap: (index) {
                      viewModel.handleOnMachineTap(context,
                          viewModel.uploadControllerList[index], index);
                    },
                    onSuffixTap: (index) async {
                    ...
                    uploadValidator: (value, index) {
                      ...
                      //       viewModel.machineFileSizeModel[i]);
                      // }
                      // return null;
                    },
                    validator: (value, index) {
                      return viewModel
                          .emptyValidation(viewModel.controllerList[index]);
                    },
                    onAdd: () {
                      viewModel.onAdd();
                    },
