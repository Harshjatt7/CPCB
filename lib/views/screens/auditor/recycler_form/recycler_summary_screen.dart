...
// import '../../../widgets/app_components/common_progress_bar.dart';
// import '../../../widgets/app_components/common_title_widget.dart';
// import '../../../widgets/components/common_appbar.dart';

// class AuditorSummaryScreen extends StatelessWidget {
//   AuditorSummaryScreen({super.key});
...
//                       title: "GPS Location of the unit",
...
//                       child: CommonTextWidget("Other Remark",
...
//                           child: CommonTitleWidget(
//                             label:
//                                 viewModel.stringConstants.geotaggedPhotographs,
//                           ),
//                         ),
//                         AuditorFormTile(
//                           isMandatory: true,
...
//                       isMandatory: true,
//                       groupValue: viewModel.radioPanNo,
//                       title: "Other Waste Material Storage area",
//                       isUpload: true,
//                       disableController: viewModel.panNoController,
//                       remarkController: viewModel.remarkPanNoController,
//                       uploadController: viewModel.uploadPanNoController,
...
//                       child: CommonTitleWidget(
//                           label: "(D).Details of Plant Machinery"),
//                     ),
//                     Padding(
//                         padding: const EdgeInsets.symmetric(vertical: 8),
//                         child: Column(
...
//                               isMandatory: true,
//                               groupValue: viewModel.radioPanNo,
//                               title: "Details of Plant Machinery",
//                               isUpload: true,
//                               disableController: viewModel.panNoController,
//                               remarkController: viewModel.remarkPanNoController,
//                               uploadController: viewModel.uploadPanNoController,
...
//                               isMandatory: true,
//                               groupValue: viewModel.radioPanNo,
//                               title: "Capacity of Plant Machinery",
//                               disableController: viewModel.panNoController,
//                               remarkController: viewModel.remarkPanNoController,
//                               onChanged: (value) {
//                                 viewModel.radioPanNo = value ?? "";
...
//                               isMandatory: true,
//                               groupValue: viewModel.radioPanNo,
//                               title: "Power of Plant Machinery",
//                               disableController: viewModel.panNoController,
//                               remarkController: viewModel.remarkPanNoController,
//                               onChanged: (value) {
//                                 viewModel.radioPanNo = value ?? "";
...
//                               },
//                             ),
//                             //TODO: Is plant machinery available for the end product selected
//                           ],
//                         )),
//                     const Padding(
//                       padding: EdgeInsets.symmetric(vertical: 8),
//                       child: CommonTitleWidget(label: "(E). Power Load"),
//                     ),
//                     AuditorFormTile(
//                       isMandatory: true,
//                       groupValue: viewModel.radioPanNo,
//                       title: "Electricity BiIl of last year",
//                       disableController: viewModel.panNoController,
//                       remarkController: viewModel.remarkPanNoController,
//                       onChanged: (value) {
//                         viewModel.radioPanNo = value ?? "";
...
//                             ),
//                           )
//                           //TODO: (H). Summary of Audit (Max 500 words)
//                         ],
//                       ),
//                     ),
//                   ],
