...
class AuditorRecyclerForm2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return isSummaryScreen == false
        ? BaseView<RecyclerForm2ViewModel>(
            ...
            builder: (context, viewModel, child) {
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    CommonTitleWidget(
                        label: stringConstants.plantCapacityAssessment),
                    Padding(
                    ...
                    commonRecyclerForm2Tile(
                        ...
                        validator: (value) {
                          return viewModel.emptyValidation(viewModel
                              .differenceInActualProccessingController);
                        },
                        isDisable: false),
                    commonRecyclerForm2Tile(
                        ...
                        hintText: "", //Value will come from API
                        textEditingController:
                            viewModel.totalQuantitySalesController,
                        isDisable: true),
                    commonRecyclerForm2Tile(
                    ...
                    commonRecyclerForm2Tile(
                        ...
                        hintText: stringConstants.enter,
                        textEditingController:
                            viewModel.powerConsumptionController,
                        validator: (value) {
                          return viewModel.emptyValidation(
                              viewModel.powerConsumptionController);
                        },
                    ...
                    commonRecyclerForm2Tile(
                        ...
                        hintText: stringConstants.enter,
                        textEditingController:
                            viewModel.totalElectricityController,
                        validator: (value) {
                          return viewModel.emptyValidation(
                              viewModel.totalElectricityController);
                        },
                    ...
                    Padding(
                      ...
                      child: CommonTextFormFieldWidget(
                          ...
                          validator: (value) {
                            return viewModel.emptyValidation(
                                viewModel.areValuedCandDController);
                          },
