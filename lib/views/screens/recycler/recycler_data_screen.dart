                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final recyclerDetails =
                                      viewModel.recyclerData?[index];
                                  return Padding(
                                    padding:
                                    ...
                                    child: CommonRetraderDataCard(
                                      name: recyclerDetails
                                          ...
                                          "",
                                      contactDetails: recyclerDetails
                                              ?.wasteTyreSupplierContact ??
                                          "",
                                      address: recyclerDetails
                                              ?.wasteTyreSupplierAddress ??
                                          "",
                                      invoiceNumber: "",
                                      gstNumber: recyclerDetails
                                              ?.wasteTyreSupplierGst ??
                                          "",
                                      typeOfRaw: recyclerDetails
                                              ?.typeOfRecycledMaterial ??
                                          "",
                                      total: "",
                                      date: recyclerDetails?.recycledDate ?? "",
                                      year:
                                          recyclerDetails?.financialYear ?? "",
                                    ),
                                  );
                                },
                              ),
                              ...
                              child: CommonButtonWidget(
                                onPressed: () {
                                  Navigator.pushNamed(context,
                                      AppRoutes.recyclerAddDataScreenRoute);
                                },
