                      ...
                      children: [
                          ...
                          itemBuilder: (context, index) {
                            return const Padding(
                              ...
                              child: ProducerListTile(
                                  title: 'User Type', subtitle: 'Producer'),
                            );
                          },
                        ),
                        CommonNote(
                            note: MessageConstant().producerDashBoardNote),
                        Padding(
                        ...
                        CommonButtonWidget(
                          ...
                          labelStyle: Theme.of(context)
                              .textTheme
                              .labelMedium!
                              .copyWith(color: AppColor().darkGreen18632E),
                        )
                      ],
                    ),
                  ),
                                ...
                                child: Padding(
                                  ...
                                  child: CommonTextWidget(
                                    ...
                                    style: Theme.of(context)
                                        ...
                                        .displaySmall!
                                        .copyWith(
                                            color: AppColor().environmentDesc),
                                  ),
                                ),
                              ),
                              CommonTextWidget(MessageConstant().environmentText,style: Theme.of(context).textTheme.displaySmall,)
                            ],
                          ),
                        )
                      ]),
