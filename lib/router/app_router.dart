...
import 'package:cpcb_tyre/views/screens/auditor/retreader_form/retreader_stepper_form.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.auditorStepperScreen:
        CheckUserAndSummaryScreen checkUser =
            settings.arguments as CheckUserAndSummaryScreen;
        return _getPageRoute(
            CommonStepperScreen(checkUser: checkUser), settings);
      ...
      case AppRoutes.recyclerStepperScreenRoute:
        return _getPageRoute(const RecyclerStepper(), settings);
      case AppRoutes.retreaderStepperScreenRoute:
        return _getPageRoute(const RetreaderStepper(), settings);
      case AppRoutes.producerStepperScreenRoute:
        return _getPageRoute(const ProdcerStepper(), settings);
